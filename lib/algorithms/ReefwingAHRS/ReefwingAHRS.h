...
class ReefwingAHRS {
  public:
    ...
    void setData(IMUSensors d, bool axisAlign = true);
    void setDOF(DOF d);
    ...
    void madgwickUpdate(IMUSensors d, float deltaT); 
    void mahonyUpdate(IMUSensors d, float deltaT);
    void extendedKalmanUpdate(IMUSensors d, float deltaT); 
    void complementaryUpdate(IMUSensors d, float deltaT);
    
    IMUSensors gyroToRadians();
  ...
  private:
    ...
    IMUSensors _data;   //  Sensor Data: gyro - DPS, accel - g's, mag - gauss
