...
IMUSensors ReefwingAHRS::gyroToRadians() {
  //  Convert gyro data from DPS to radians/sec.
  IMUSensors filterData = _data;
...
void ReefwingAHRS::setData(IMUSensors d, bool axisAlign) {
...
void ReefwingAHRS::extendedKalmanUpdate(IMUSensors d, float deltaT) {
...
void ReefwingAHRS::complementaryUpdate(IMUSensors d, float deltaT) {
...
void ReefwingAHRS::madgwickUpdate(IMUSensors d, float deltaT) {
  float norm;
...
void ReefwingAHRS::mahonyUpdate(IMUSensors d, float deltaT) {
  float norm;
  float hx, hy, bx, bz;
